        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {advisers.map(a => (
              ...
              >
                <span className="text-cyan-400 font-bold text-lg w-8 shrink-0">{a.num}</span>
                <div>
            ...
            {/* Chairman */}
            <div className="flex items-start gap-4 bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-cyan-400/40 transition-colors sm:col-span-2">
              <span className="text-cyan-400 font-bold text-lg w-8 shrink-0">★</span>
              <div>
