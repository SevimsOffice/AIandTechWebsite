...
const translations = {
  en: {
    ...
    'trainings.catalog.journey.title': 'Your Learning Paths',
    'trainings.catalog.journey.all.label': 'All Programs',
    'trainings.catalog.journey.all.desc': 'See all',
    'trainings.catalog.journey.bireysel.label': 'Individual',
    'trainings.catalog.journey.bireysel.desc': 'Learn at your pace',
    'trainings.catalog.journey.takim.label': 'Team & Corporate',
    'trainings.catalog.journey.takim.desc': 'Transform your team',
    'trainings.catalog.journey.donusum.label': 'Deep Transformation',
    'trainings.catalog.journey.donusum.desc': 'Comprehensive solution',
    'trainings.catalog.filter.all': 'All',
    'trainings.catalog.filter.individual': 'Individual',
    'trainings.catalog.filter.team': 'Team & Corporate',
    'trainings.catalog.filter.transformation': 'Deep Transformation',
    'trainings.catalog.count': 'programs',
    'trainings.catalog.empty': 'No programs found in this category.',
    'trainings.catalog.card.details': 'Details',
    'trainings.catalog.card.online': 'Online / In-person',
    'trainings.catalog.card.inperson': 'In-person',
    'trainings.catalog.recommended.label': 'Recommended Path',
    'trainings.catalog.recommended.title': 'Where Should You Start?',
    'trainings.catalog.recommended.desc': 'Start individual, scale to team transformation.',
    'trainings.catalog.corporate.badge': 'Corporate Training',
    'trainings.catalog.corporate.title1': "Let's Design a Custom Program",
    'trainings.catalog.corporate.title2': 'For Your Team',
    'trainings.catalog.corporate.desc': 'All programs can be customized by sector, team size, and organizational needs. Group pricing and on-site training options are available.',
    'trainings.catalog.corporate.cta': 'Schedule Discovery Call',
    'trainings.catalog.corporate.free': 'Free discovery call',
    'trainings.catalog.corporate.custom': 'Content tailored to your sector',
    // Training Detail Page
    'trainings.detail.back': 'All Trainings',
    'trainings.detail.prefix': 'TRAINING #',
    'trainings.detail.cta.hero': 'Schedule Discovery Call',
    'trainings.detail.overview': 'Overview',
    'trainings.detail.outcomes': 'What Will You Gain?',
    'trainings.detail.modules': 'Program Content',
    'trainings.detail.audience': 'Who Is This Training For?',
    'trainings.detail.others': 'Other Programs',
    'trainings.detail.sidebar.duration': 'Duration',
    'trainings.detail.sidebar.format': 'Format',
    'trainings.detail.sidebar.level': 'Level',
    'trainings.detail.sidebar.prereqs': 'Prerequisites',
    'trainings.detail.sidebar.includes': "What's Included",
    'trainings.detail.sidebar.cta': 'Book Appointment',
    'trainings.detail.sidebar.free': 'Free · Opens in new window',
  },
  tr: {
    // Header
    ...
    // Training Catalog Page
    'trainings.catalog.journey.title': 'Öğrenme Yollarınız',
    'trainings.catalog.journey.all.label': 'Tüm Programlar',
    'trainings.catalog.journey.all.desc': 'Hepsini gör',
    'trainings.catalog.journey.bireysel.label': 'Bireysel',
    'trainings.catalog.journey.bireysel.desc': 'Kendi hızında öğren',
    'trainings.catalog.journey.takim.label': 'Takım & Kurum',
    'trainings.catalog.journey.takim.desc': 'Ekibinle dönüşüm',
    'trainings.catalog.journey.donusum.label': 'Derin Dönüşüm',
    'trainings.catalog.journey.donusum.desc': 'Kapsamlı çözüm',
    'trainings.catalog.filter.all': 'Tümü',
    'trainings.catalog.filter.individual': 'Bireysel',
    'trainings.catalog.filter.team': 'Takım & Kurum',
    'trainings.catalog.filter.transformation': 'Derin Dönüşüm',
    'trainings.catalog.count': 'program',
    'trainings.catalog.empty': 'Bu kategoride program bulunamadı.',
    'trainings.catalog.card.details': 'Detaylar',
    'trainings.catalog.card.online': 'Online / Yüz yüze',
    'trainings.catalog.card.inperson': 'Yüz yüze',
    'trainings.catalog.recommended.label': 'Önerilen Yol',
    'trainings.catalog.recommended.title': 'Nereden Başlamalısınız?',
    'trainings.catalog.recommended.desc': 'Bireysel başlayıp kurumsal dönüşüme uzanın.',
    'trainings.catalog.corporate.badge': 'Kurumsal Eğitim',
    'trainings.catalog.corporate.title1': 'Ekibiniz İçin Özelleştirilmiş',
    'trainings.catalog.corporate.title2': 'Program Tasarlayalım',
    'trainings.catalog.corporate.desc': 'Tüm programlar sektör, ekip büyüklüğü ve organizasyonun ihtiyaçlarına göre özelleştirilebilir. Grup fiyatlandırması ve yerinde eğitim seçenekleri mevcuttur.',
    'trainings.catalog.corporate.cta': 'Keşif Görüşmesi Ayarla',
    'trainings.catalog.corporate.free': 'Ön keşif görüşmesi ücretsiz',
    'trainings.catalog.corporate.custom': 'İçerik sektöre özel',
    // Training Detail Page
    'trainings.detail.back': 'Tüm Eğitimler',
    'trainings.detail.prefix': 'EĞİTİM #',
    'trainings.detail.cta.hero': 'Keşif Görüşmesi Ayarla',
    'trainings.detail.overview': 'Genel Bakış',
    'trainings.detail.outcomes': 'Ne Kazanacaksınız?',
    'trainings.detail.modules': 'Program İçeriği',
    'trainings.detail.audience': 'Bu Eğitim Kimin İçin?',
    'trainings.detail.others': 'Diğer Programlar',
    'trainings.detail.sidebar.duration': 'Süre',
    'trainings.detail.sidebar.format': 'Format',
    'trainings.detail.sidebar.level': 'Seviye',
    'trainings.detail.sidebar.prereqs': 'Ön Koşul',
    'trainings.detail.sidebar.includes': 'Dahil Olanlar',
    'trainings.detail.sidebar.cta': 'Randevu Al',
    'trainings.detail.sidebar.free': 'Ücretsiz · Yeni pencerede açılır',
  }
};
